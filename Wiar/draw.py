...
for line in f1:
    ...
    # if (string.find(line, 'train') != -1):
        Train_Loss_list.append(float(line[66:72]))
        Train_Mae_list.append(float(line[80:86]))
    # if (string.find(line, 'valid') != -1):
        Valid_Loss_list.append(float(line[113:119]))
        Valid_Mae_list.append(float(line[131:137]))
f1.close()
