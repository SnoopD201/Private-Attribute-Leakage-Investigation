...
data_dir = '/export/shiyd/Wiar'
ALL_MOTION=[1,2]
# gender
# ALL_MOTION =[85,75,65,60,50,65,85,70]
# ALL_MOTION = [1,2,3,4]
    ...
    for data_root, data_dirs, data_files in os.walk(path_to_data):#遍历所有文件
        for data_file_name in data_files:
            ...
            try:
                ...
                gender=int(data_file_name.split('_')[0])
                # print(height)
                #拆分文件名
 
                if(gender not in motion_sel):
                    continue
