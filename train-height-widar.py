...
def load_data(path_to_data, motion_sel):
    ...
    data = []
    label = []
    for data_root, data_dirs, data_files in os.walk(path_to_data):#Iterate through all files
        for data_file_name in data_files:
            ...
            data.append(data_normed_1.tolist()) #convert to list
            label.append(height) #add label
